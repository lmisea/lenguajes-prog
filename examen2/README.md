# Examen 2 - Lenguajes de Programación I (CI-3641)
...
Examen 2 del curso Lenguajes de Programación I (CI-3641) de la Universidad Simón Bolívar, del trimestre Sep - Dic 2025.

El lenguaje escogido para el examen es **Python**, ya que la inicial de mi segundo apellido es "P".
